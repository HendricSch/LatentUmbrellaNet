 """Dummy-Datenmodule zum schnellen Testen von Trainings-Loops."""
...
class DummyDataset(torch.utils.data.Dataset):
    """Liefert wiederholt denselben Zufallstensor in Zielgröße."""
...
class DummyDataModule(pl.LightningDataModule):
    """Lightning DataModule auf Basis des `DummyDataset`."""
    def __init__(self, config, size):
        super().__init__()
        self.config = config
        self.size = size

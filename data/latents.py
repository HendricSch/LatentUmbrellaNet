 """Dataloader für vorab berechnete latente Darstellungen (Zarr-Store).

 Ermöglicht Training eines Vorhersagenetzes im latenten Raum.
 """
...
def gen_latents_bgen(zarr_path: str, train: bool) -> xb.BatchGenerator:
    """Erzeugt einen BatchGenerator über einen Zarr-Store latenter Darstellungen.

    Schneidet in Zeitdimension mit 90/10 Split in Train/Val.
    """

 """Encoder-Baustein des Autoencoders.

 Mehrstufige Downsampling-Architektur mit optionaler Attention in der Mitte.
 Gibt pro räumlicher Position die Momente (µ, log σ²) für eine Normalverteilung aus.
 """
...
class Encoder(nn.Module):
    """Hierarchischer Encoder, der Eingaben in latente Darstellungn projeziert."""

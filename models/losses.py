 """Verlustfunktionen und Hilfslogik für das Training.

 Enthält:
 - breitengrad-gewichtete RMSE-Variante,
 - Generator/Discriminator-Verluste (hinge/vanilla),
 - kombinierte Rekonstruktions-/KL-/Diskriminator-Fehlerfunktionen.
 """
...
class RecKLDiscriminatorLoss(nn.Module):
    """Kombinierter Verlust für Generator (Rekonstruktion + KL + GAN) und Diskriminator."""
    ...
    def calculate_adaptive_weight(self, rec_loss, g_loss, last_layer):
        """Bestimmt adaptives Gewicht für GAN-Anteil basierend auf Gradientenverhältnis."""
    ...
    def forward(
        ...
        """Berechnet Verlust und Log-Werte für Generator- oder Diskriminatorschritt."""
